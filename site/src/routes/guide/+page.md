...
├── docs/songs/     # Song definition markdown files
...
Create a new markdown file in `docs/songs/` following the [Song Format](/guide/song-format) specification:
...
- [Song Format](/guide/song-format) — Full specification for song markdown files
- [Style Prompts](/guide/style-prompts) — How to craft effective style prompts
- [Meta-Tags Reference](/guide/meta-tags) — Complete list of Suno meta-tags
- [Generation Tips](/guide/generation-tips) — Best practices for generating quality tracks
